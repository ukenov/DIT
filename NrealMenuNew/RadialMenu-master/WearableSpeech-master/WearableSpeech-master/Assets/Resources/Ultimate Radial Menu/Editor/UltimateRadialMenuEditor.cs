...
public class UltimateRadialMenuEditor : Editor
{
	...
	void StoreReferences ()
	{
		...
		if( targ.nameText != null && targ.nameText.GetComponent<Outline>() )
			nameTextOutlineColor = targ.nameText.GetComponent<Outline>().effectColor;
		...
		if( targ.descriptionText != null && targ.descriptionText.GetComponent<Outline>() )
			descriptionTextOutlineColor = targ.descriptionText.GetComponent<Outline>().effectColor;
				...
				if( targ.displayButtonName )
				{
					...
					else if( targ.nameText != null )
					{
						...
						if( EditorGUI.EndChangeCheck() )
						{
							...
							if( targ.nameText != null )
							{
								if( targ.nameOutline && !targ.nameText.gameObject.GetComponent<Outline>() )
								{
									Undo.RecordObject( targ.nameText.gameObject, "Update Text Outline" );
									targ.nameText.gameObject.AddComponent<Outline>();

									nameTextOutlineColor = targ.nameText.gameObject.GetComponent<Outline>().effectColor;
								}

								if( targ.nameText.gameObject.GetComponent<Outline>() )
								{
									Undo.RecordObject( targ.nameText.gameObject.GetComponent<Outline>(), "Update Text Outline" );
									targ.nameText.gameObject.GetComponent<Outline>().enabled = targ.nameOutline;
								}
							}
						}
						...
						if( targ.nameOutline )
						{
							...
							if( EditorGUI.EndChangeCheck() )
							{
								if( targ.nameText != null && targ.nameText.GetComponent<Outline>() )
								{
									Undo.RecordObject( targ.nameText.GetComponent<Outline>(), "Update Text Outline" );
									targ.nameText.GetComponent<Outline>().enabled = false;
									targ.nameText.GetComponent<Outline>().effectColor = nameTextOutlineColor;
									targ.nameText.GetComponent<Outline>().enabled = true;
								}
							}
				...
				if( targ.displayButtonDescription )
				{
					...
					else if( targ.descriptionText != null )
					{
						...
						if( EditorGUI.EndChangeCheck() )
						{
							...
							if( targ.descriptionText != null )
							{
								if( targ.descriptionOutline && !targ.descriptionText.gameObject.GetComponent<Outline>() )
								{
									Undo.RecordObject( targ.descriptionText.gameObject, "Update Text Outline" );
									targ.descriptionText.gameObject.AddComponent<Outline>();

									descriptionTextOutlineColor = targ.descriptionText.gameObject.GetComponent<Outline>().effectColor;
								}

								if( targ.descriptionText.gameObject.GetComponent<Outline>() )
								{
									Undo.RecordObject( targ.descriptionText.gameObject.GetComponent<Outline>(), "Update Text Outline" );
									targ.descriptionText.gameObject.GetComponent<Outline>().enabled = targ.descriptionOutline;
								}
							}
						}
						...
						if( targ.descriptionOutline )
						{
							...
							if( EditorGUI.EndChangeCheck() )
							{
								if( targ.descriptionText != null && targ.descriptionText.GetComponent<Outline>() )
								{
									Undo.RecordObject( targ.descriptionText.GetComponent<Outline>(), "Update Text Outline" );
									targ.descriptionText.GetComponent<Outline>().enabled = false;
									targ.descriptionText.GetComponent<Outline>().effectColor = descriptionTextOutlineColor;
									targ.descriptionText.GetComponent<Outline>().enabled = true;
								}
							}
							GUILayoutAfterIndentSpace();
							EditorGUI.indentLevel--;
			...
			if( DisplayCollapsibleBoxSection( "Button Text", "URM_ButtonText", useButtonText, ref valueChanged ) )
			{
				...
				if( EditorGUI.EndChangeCheck() )
				{
					...
					for( int i = 0; i < targ.UltimateRadialButtonList.Count; i++ )
					{
						...
						{
							if( targ.buttonTextOutline && !targ.UltimateRadialButtonList[ i ].text.gameObject.GetComponent<Outline>() )
							{
								Undo.RecordObject( targ.UltimateRadialButtonList[ i ].text.gameObject, "Update Text Outline" );
								targ.UltimateRadialButtonList[ i ].text.gameObject.AddComponent<Outline>();

								buttonTextOutlineColor.colorValue = targ.UltimateRadialButtonList[ i ].text.gameObject.GetComponent<Outline>().effectColor;
								serializedObject.ApplyModifiedProperties();
							}

							if( targ.UltimateRadialButtonList[ i ].text.gameObject.GetComponent<Outline>() )
							{
								Undo.RecordObject( targ.UltimateRadialButtonList[ i ].text.gameObject.GetComponent<Outline>(), "Update Text Outline" );
								targ.UltimateRadialButtonList[ i ].text.gameObject.GetComponent<Outline>().enabled = targ.buttonTextOutline;
							}
						}
					}
				}
				...
				if( targ.buttonTextOutline )
				{
					...
					if( EditorGUI.EndChangeCheck() )
					{
						...
						for( int i = 0; i < targ.UltimateRadialButtonList.Count; i++ )
						{
							if( targ.UltimateRadialButtonList[ i ].text != null && targ.UltimateRadialButtonList[ i ].text.GetComponent<Outline>() )
							{
								Undo.RecordObject( targ.UltimateRadialButtonList[ i ].text.GetComponent<Outline>(), "Update Text Outline" );
								targ.UltimateRadialButtonList[ i ].text.GetComponent<Outline>().enabled = false;
								targ.UltimateRadialButtonList[ i ].text.GetComponent<Outline>().effectColor = targ.buttonTextOutlineColor;
								targ.UltimateRadialButtonList[ i ].text.GetComponent<Outline>().enabled = true;
							}
						}
					}
					GUILayoutAfterIndentSpace();
				...
				for( int i = 0; i < targ.UltimateRadialButtonList.Count; i++ )
				{
					if( targ.useButtonText )
					{
						if( targ.UltimateRadialButtonList[ i ].text == null )
						{
							...
							if( targ.buttonTextOutline && !newText.gameObject.GetComponent<Outline>() )
								newText.gameObject.AddComponent<Outline>();
	...
	void AddNewRadialButton ( int index )
	{
		...
		if( targ.useButtonText )
		{
			...
			if( targ.buttonTextOutline )
			{
				Outline textOutline = textComponent.gameObject.AddComponent<Outline>();
	...
	void RequestCanvas ( GameObject child, bool screenSpaceOverlay = true )
	{
		...
		Canvas canvas = newCanvasObject.AddComponent<Canvas>();
